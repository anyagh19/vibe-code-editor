...
const TemplateSelectionModal = ({
  ...
  const handleCreateProject = () => {
    if (selectedTemplate) {
      ...
      onSubmit({
        title: projectName ||  `My ${template?.name} Project`,
                    ...
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02] 
                            ${selectedTemplate === template.id ? "border-[#E93F3F] shadow-[0_4px_20px_rgba(233,63,63,0.1)]" : "border-transparent hover:border-gray-300 hover:shadow-[0_2px_10px_rgba(0,0,0,0.05)]"}`}
